            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    while (i < vlength) {
                        switch (vectorObj[i]) {
                            case "10:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='10:00']").attr("disabled", true);
                                break;
                            case "11:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='11:00']").attr("disabled", true);
                                break;
                            case "12:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='12:00']").attr("disabled", true);
                                break;
                            case "13:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='13:00']").attr("disabled", true);
                                break;
                            case "16:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='16:00']").attr("disabled", true);
                                break;
                            case "17:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='17:00']").attr("disabled", true);
                                break;
                            case "18:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='18:00']").attr("disabled", true);
                                break;
                            case "19:00:00":
                                $("#hour-<?= $cita->getID(); ?> option[value='19:00']").attr("disabled", true);
                                break;
                        }
                        i++;
                    }
